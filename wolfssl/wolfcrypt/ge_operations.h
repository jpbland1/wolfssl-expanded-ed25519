...
WOLFSSL_API int  ge_frombytes_negate_vartime(ge_p3 *h,const unsigned char *s);

WOLFSSL_API int  ge_double_scalarmult_vartime(ge_p2 *r, const unsigned char *a,
...
WOLFSSL_API void sc_reduce(byte* s);
WOLFSSL_API void sc_muladd(byte* s, const byte* a, const byte* b,
                             const byte* c);
//WOLFSSL_LOCAL void ge_tobytes(unsigned char *s,const ge_p2 *h);
WOLFSSL_API void ge_tobytes(unsigned char *s,const ge_p2 *h);
